...
const ChatBot = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {open && (
        <div className="mb-4 w-[30rem] max-w-[calc(100vw-3rem)] rounded-2xl bg-cream border border-cream-darker shadow-card flex flex-col overflow-hidden" style={{ height: '40rem' }}>
          {/* Header */}
      ...
      <button
        ...
        className="w-20 h-20 rounded-full bg-forest text-cream shadow-card flex items-center justify-center hover:bg-forest-mid transition-all duration-200 active:scale-90"
      >
        {open ? (
